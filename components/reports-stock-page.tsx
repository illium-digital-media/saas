          ...
          <div className="flex flex-col gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>View inventory and stock level reports.</CardDescription>
              </CardHeader>
              <CardContent>
                <p>This page provides detailed reports on inventory levels, stock turnover, and product performance.</p>
              </CardContent>
            </Card>
          </div>
        </main>
