...
export function SalesExchangePage() {
        ...
        <main className="flex-1 p-6">
          <div className="flex flex-col gap-6">
            <div className="flex items-center justify-between">
              <h1 className="text-2xl font-bold">Part Exchange</h1>
            </div>
            <Card>
              <CardHeader>
                <CardTitle>Part Exchange</CardTitle>
                <CardDescription>Manage your watch part exchange process here.</CardDescription>
              </CardHeader>
              <CardContent>
                <p>This page allows you to manage the process of part exchanging watches with customers.</p>
              </CardContent>
            </Card>
          </div>
        </main>
