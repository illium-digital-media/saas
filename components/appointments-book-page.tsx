...
export function AppointmentsBookPage() {
          ...
          <div className="flex flex-col gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Schedule new appointments with customers.</CardDescription>
              </CardHeader>
              <CardContent>
                <p>This page allows you to schedule and manage new appointments with customers.</p>
              </CardContent>
            </Card>
          </div>
        </main>
