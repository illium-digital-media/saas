...
export function RepairsRequestsPage() {
          ...
          <div className="flex flex-col gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage incoming repair requests from customers.</CardDescription>
              </CardHeader>
              <CardContent>
                <p>This page allows you to manage and process new repair requests from customers.</p>
              </CardContent>
            </Card>
          </div>
        </main>
