          ...
          <div className="flex flex-col gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>View your complete inventory at a glance.</CardDescription>
              </CardHeader>
              <CardContent>
                <p>This page provides a comprehensive overview of your current inventory and stock levels.</p>
              </CardContent>
            </Card>
          </div>
        </main>
