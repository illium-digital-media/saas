...
export function RepairsTrackingPage() {
          ...
          <div className="flex flex-col gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Track the status of ongoing repairs.</CardDescription>
              </CardHeader>
              <CardContent>
                <p>This page allows you to track and update the status of repairs currently in progress.</p>
              </CardContent>
            </Card>
          </div>
        </main>
