...
export function InvoicingRefundsPage() {
          ...
          <div className="flex flex-col gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Process refunds and manage returns.</CardDescription>
              </CardHeader>
              <CardContent>
                <p>This page allows you to process refunds and manage product returns from customers.</p>
              </CardContent>
            </Card>
          </div>
        </main>
