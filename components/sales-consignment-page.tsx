...
export function SalesConsignmentPage() {
          ...
          <div className="flex flex-col gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage your watch consignment process here.</CardDescription>
              </CardHeader>
              <CardContent>
                <p>This page allows you to manage the process of handling consignment watches from customers.</p>
              </CardContent>
            </Card>
          </div>
        </main>
