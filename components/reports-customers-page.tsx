          ...
          <div className="flex flex-col gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>View customer behavior and purchasing patterns.</CardDescription>
              </CardHeader>
              <CardContent>
                <p>This page provides detailed reports on customer behavior, purchasing patterns, and demographics.</p>
              </CardContent>
            </Card>
          </div>
        </main>
