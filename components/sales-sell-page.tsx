        ...
        <main className="flex-1 p-6">
          <div className="flex flex-col gap-6">
            <div className="flex items-center justify-between">
              <h1 className="text-2xl font-bold">Sell Watches</h1>
            </div>
            <Card>
              <CardHeader>
                <CardTitle>Sell Watches</CardTitle>
                <CardDescription>Manage your watch sales process here.</CardDescription>
              </CardHeader>
              <CardContent>
                <p>This page allows you to manage the process of selling watches from your inventory.</p>
              </CardContent>
            </Card>
          </div>
        </main>
